...
import top.xuqingquan.webbak.nokernel.ActionActivity.KEY_FROM_INTENTION
import top.xuqingquan.webbak.publics.AgentWebUtils
import top.xuqingquan.webbak.publics.IVideo
import top.xuqingquan.webbak.publics.IndicatorController
...
class DefaultChromeClient(
    ...
    private fun onGeolocationPermissionsShowPromptInternal(origin: String, callback: GeolocationPermissions.Callback) {
