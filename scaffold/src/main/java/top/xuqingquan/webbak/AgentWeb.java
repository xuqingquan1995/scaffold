...
import top.xuqingquan.webbak.publics.*;
...
public final class AgentWeb {
     ...
     * 管理 WebSettings
     */
    private top.xuqingquan.webbak.system.IAgentWebSettings mAgentWebSettings;
    private top.xuqingquan.webbak.x5.IAgentWebSettings mX5AgentWebSettings;
    /**
     ...
     * WebListenerManager
     */
    private top.xuqingquan.webbak.system.WebListenerManager mWebListenerManager;
    private top.xuqingquan.webbak.x5.WebListenerManager mX5WebListenerManager;
    /**
     * Activity
     */
     ...
     */
    private top.xuqingquan.webbak.system.MiddlewareWebClientBase mMiddleWrareWebClientBaseHeader;
    private top.xuqingquan.webbak.x5.MiddlewareWebClientBase mX5MiddleWrareWebClientBaseHeader;
    /**
     * MiddlewareWebChromeBase WebChromeClient 中间件
     */
    private top.xuqingquan.webbak.system.MiddlewareWebChromeBase mMiddlewareWebChromeBaseHeader;
    private top.xuqingquan.webbak.x5.MiddlewareWebChromeBase mX5MiddlewareWebChromeBaseHeader;
    /**
     * 事件拦截
     */
    ...
    public top.xuqingquan.webbak.system.IAgentWebSettings getAgentWebSettings() {
        return this.mAgentWebSettings;
    }

    public top.xuqingquan.webbak.x5.IAgentWebSettings getX5AgentWebSettings() {
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup.LayoutParams lp, int indicatorColor, int height_dp, android.webkit.WebView webView, top.xuqingquan.webbak.system.IWebLayout webLayout) {
    ...
    private WebCreator configWebCreator(BaseIndicatorView progressView, int index, ViewGroup.LayoutParams lp, int indicatorColor, int height_dp, com.tencent.smtt.sdk.WebView webView, top.xuqingquan.webbak.x5.IWebLayout webLayout) {
        if (progressView != null && mEnableIndicator) {
            return new DefaultWebCreator(mActivity, mViewGroup, lp, index, progressView, webView, webLayout);
        } else {
            return mEnableIndicator ?
    ...
    private android.webkit.WebViewClient getWebViewClient() {
        ...
        top.xuqingquan.webbak.system.DefaultWebClient mDefaultWebClient = top.xuqingquan.webbak.system.DefaultWebClient
                .createBuilder()
                ...
                .build();
        top.xuqingquan.webbak.system.MiddlewareWebClientBase header = this.mMiddleWrareWebClientBaseHeader;
        if (header != null) {
            top.xuqingquan.webbak.system.MiddlewareWebClientBase tail = header;
            int count = 1;
            top.xuqingquan.webbak.system.MiddlewareWebClientBase tmp = header;
            while (tmp.next() != null) {
                tmp = tmp.next();
                tail = tmp;
                count++;
    ...
    private com.tencent.smtt.sdk.WebViewClient getX5WebViewClient() {
        ...
        top.xuqingquan.webbak.x5.DefaultWebClient mDefaultWebClient = top.xuqingquan.webbak.x5.DefaultWebClient
                .createBuilder()
                .setActivity(this.mActivity)
                ...
                .setUrlHandleWays(this.mUrlHandleWays)
                .build();
        top.xuqingquan.webbak.x5.MiddlewareWebClientBase header = this.mX5MiddleWrareWebClientBaseHeader;
        if (header != null) {
            top.xuqingquan.webbak.x5.MiddlewareWebClientBase tail = header;
            int count = 1;
            top.xuqingquan.webbak.x5.MiddlewareWebClientBase tmp = header;
            while (tmp.next() != null) {
                tmp = tmp.next();
                tail = tmp;
                count++;
    ...
    private AgentWeb ready() {
        ...
        if (WebConfig.hasX5()) {
            top.xuqingquan.webbak.x5.IAgentWebSettings mAgentWebSettings = this.mX5AgentWebSettings;
            if (mAgentWebSettings == null) {
                this.mX5AgentWebSettings = top.xuqingquan.webbak.x5.AgentWebSettingsImpl.getInstance();
                mAgentWebSettings = top.xuqingquan.webbak.x5.AgentWebSettingsImpl.getInstance();
            }
            if (mAgentWebSettings instanceof top.xuqingquan.webbak.x5.AbsAgentWebSettings) {
                ((top.xuqingquan.webbak.x5.AbsAgentWebSettings) mAgentWebSettings).bindAgentWeb(this);
            }
            if (mX5WebListenerManager == null && mAgentWebSettings instanceof top.xuqingquan.webbak.x5.AbsAgentWebSettings) {
                mX5WebListenerManager = (top.xuqingquan.webbak.x5.WebListenerManager) mAgentWebSettings;
            }
            ...
            top.xuqingquan.webbak.system.IAgentWebSettings mAgentWebSettings = this.mAgentWebSettings;
            if (mAgentWebSettings == null) {
                this.mAgentWebSettings = top.xuqingquan.webbak.system.AgentWebSettingsImpl.getInstance();
                mAgentWebSettings = top.xuqingquan.webbak.system.AgentWebSettingsImpl.getInstance();
            }
            if (mAgentWebSettings instanceof top.xuqingquan.webbak.system.AbsAgentWebSettings) {
                ((top.xuqingquan.webbak.system.AbsAgentWebSettings) mAgentWebSettings).bindAgentWeb(this);
            }
            if (mWebListenerManager == null && mAgentWebSettings instanceof top.xuqingquan.webbak.system.AbsAgentWebSettings) {
                mWebListenerManager = (top.xuqingquan.webbak.system.WebListenerManager) mAgentWebSettings;
            }
    ...
    private android.webkit.WebChromeClient getChromeClient() {
        ...
        top.xuqingquan.webbak.system.DefaultChromeClient mDefaultChromeClient =
                new top.xuqingquan.webbak.system.DefaultChromeClient(this.mActivity,
                        this.mIndicatorController,
        ...
        top.xuqingquan.webbak.system.MiddlewareWebChromeBase header = this.mMiddlewareWebChromeBaseHeader;
        if (header != null) {
            top.xuqingquan.webbak.system.MiddlewareWebChromeBase tail = header;
            int count = 1;
            top.xuqingquan.webbak.system.MiddlewareWebChromeBase tmp = header;
            for (; tmp.next() != null; ) {
                tmp = tmp.next();
                tail = tmp;
                count++;
    ...
    private com.tencent.smtt.sdk.WebChromeClient getX5ChromeClient() {
        this.mIndicatorController = (this.mIndicatorController == null) ?
                ...
                : this.mIndicatorController;
        this.mIVideo = getIVideo();
        top.xuqingquan.webbak.x5.DefaultChromeClient mDefaultChromeClient =
                new top.xuqingquan.webbak.x5.DefaultChromeClient(this.mActivity,
                        this.mIndicatorController,
        ...
        top.xuqingquan.webbak.x5.MiddlewareWebChromeBase header = this.mX5MiddlewareWebChromeBaseHeader;
        if (header != null) {
            top.xuqingquan.webbak.x5.MiddlewareWebChromeBase tail = header;
            int count = 1;
            top.xuqingquan.webbak.x5.MiddlewareWebChromeBase tmp = header;
            for (; tmp.next() != null; ) {
                tmp = tmp.next();
                tail = tmp;
                count++;
    ...
    public static final class AgentBuilder {
        ...
        private top.xuqingquan.webbak.system.IWebLayout mWebLayout = null;
        private top.xuqingquan.webbak.x5.IWebLayout mX5WebLayout = null;
        ...
        private top.xuqingquan.webbak.system.MiddlewareWebClientBase mMiddlewareWebClientBaseHeader;
        private top.xuqingquan.webbak.x5.MiddlewareWebClientBase mX5MiddlewareWebClientBaseHeader;
        private top.xuqingquan.webbak.system.MiddlewareWebClientBase mMiddlewareWebClientBaseTail;
        private top.xuqingquan.webbak.x5.MiddlewareWebClientBase mX5MiddlewareWebClientBaseTail;
        private top.xuqingquan.webbak.system.MiddlewareWebChromeBase mChromeMiddleWareHeader = null;
        private top.xuqingquan.webbak.x5.MiddlewareWebChromeBase mX5ChromeMiddleWareHeader = null;
        private top.xuqingquan.webbak.system.MiddlewareWebChromeBase mChromeMiddleWareTail = null;
        private top.xuqingquan.webbak.x5.MiddlewareWebChromeBase mX5ChromeMiddleWareTail = null;
    ...
    public static class CommonBuilder {
        ...
        public CommonBuilder useMiddlewareWebClient(@Nullable top.xuqingquan.webbak.system.MiddlewareWebClientBase middleWrareWebClientBase) {
        ...
        public CommonBuilder useMiddlewareWebClient(@Nullable top.xuqingquan.webbak.x5.MiddlewareWebClientBase middleWrareWebClientBase) {
            if (middleWrareWebClientBase == null) {
                return this;
            }
        ...
        public CommonBuilder useMiddlewareWebChrome(@Nullable top.xuqingquan.webbak.system.MiddlewareWebChromeBase middlewareWebChromeBase) {
        ...
        public CommonBuilder useMiddlewareWebChrome(@Nullable top.xuqingquan.webbak.x5.MiddlewareWebChromeBase middlewareWebChromeBase) {
            if (middlewareWebChromeBase == null) {
                return this;
            }
        ...
        public CommonBuilder setAgentWebWebSettings(@Nullable top.xuqingquan.webbak.system.IAgentWebSettings agentWebSettings) {
            this.mAgentBuilder.mAgentWebSettings = agentWebSettings;
            return this;
        }

        public CommonBuilder setAgentWebWebSettings(@Nullable top.xuqingquan.webbak.x5.IAgentWebSettings agentWebSettings) {
        ...
        public CommonBuilder setWebLayout(@Nullable top.xuqingquan.webbak.system.IWebLayout iWebLayout) {
            this.mAgentBuilder.mWebLayout = iWebLayout;
            return this;
        }

        public CommonBuilder setWebLayout(@Nullable top.xuqingquan.webbak.x5.IWebLayout iWebLayout) {
