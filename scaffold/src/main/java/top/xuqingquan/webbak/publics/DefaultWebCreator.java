...
import top.xuqingquan.webbak.nokernel.BaseIndicatorView;
import top.xuqingquan.webbak.nokernel.WebConfig;
import top.xuqingquan.webbak.nokernel.WebIndicator;
...
public class DefaultWebCreator implements WebCreator {
    ...
    private top.xuqingquan.webbak.system.IWebLayout mIWebLayout;
    private top.xuqingquan.webbak.x5.IWebLayout mX5IWebLayout;
    ...
    public DefaultWebCreator(@NonNull Activity activity,
                             ...
                             top.xuqingquan.webbak.system.IWebLayout webLayout) {
    ...
    public DefaultWebCreator(@NonNull Activity activity,
                             ...
                             top.xuqingquan.webbak.x5.IWebLayout webLayout) {
        this.mActivity = activity;
        this.mViewGroup = viewGroup;
        this.mIsNeedDefaultProgress = true;
        this.mIndex = index;
     ...
     * 关闭进度条
     */
    public DefaultWebCreator(@NonNull Activity activity, @Nullable ViewGroup viewGroup, ViewGroup.LayoutParams lp, int index, @Nullable android.webkit.WebView webView, top.xuqingquan.webbak.system.IWebLayout webLayout) {
        this.mActivity = activity;
        this.mViewGroup = viewGroup;
    ...
    public DefaultWebCreator(@NonNull Activity activity, @Nullable ViewGroup viewGroup, ViewGroup.LayoutParams lp, int index, @Nullable com.tencent.smtt.sdk.WebView webView, top.xuqingquan.webbak.x5.IWebLayout webLayout) {
        this.mActivity = activity;
        this.mViewGroup = viewGroup;
        this.mIsNeedDefaultProgress = false;
        this.mIndex = index;
     ...
     * 自定义Indicator
     */
    public DefaultWebCreator(@NonNull Activity activity, @Nullable ViewGroup viewGroup, ViewGroup.LayoutParams lp, int index, BaseIndicatorView progressView, android.webkit.WebView webView, top.xuqingquan.webbak.system.IWebLayout webLayout) {
        this.mActivity = activity;
        this.mViewGroup = viewGroup;
        this.mIsNeedDefaultProgress = false;
        this.mIndex = index;
    ...
    public DefaultWebCreator(@NonNull Activity activity, @Nullable ViewGroup viewGroup, ViewGroup.LayoutParams lp, int index, BaseIndicatorView progressView, com.tencent.smtt.sdk.WebView webView, top.xuqingquan.webbak.x5.IWebLayout webLayout) {
        this.mActivity = activity;
        this.mViewGroup = viewGroup;
        this.mIsNeedDefaultProgress = false;
        this.mIndex = index;
    ...
    private ViewGroup createLayout() {
        ...
        if (WebConfig.hasX5()) {
            ...
            Timber.i("  instanceof  AgentWebView:" + (this.mX5WebView instanceof top.xuqingquan.webbak.x5.AgentWebView));
            if (this.mX5WebView instanceof top.xuqingquan.webbak.x5.AgentWebView) {
            ...
            Timber.i("  instanceof  AgentWebView:" + (this.mWebView instanceof top.xuqingquan.webbak.system.AgentWebView));
            if (this.mWebView instanceof top.xuqingquan.webbak.system.AgentWebView) {
                WebConfig.WEBVIEW_TYPE = WebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE;
            }
        }
    ...
    private android.webkit.WebView createWebView() {
        ...
        if (this.mWebView != null) {
            ...
            mWebView = new top.xuqingquan.webbak.system.AgentWebView(mActivity);
            WebConfig.WEBVIEW_TYPE = WebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE;
        } else {
    ...
    private com.tencent.smtt.sdk.WebView createX5WebView() {
        ...
        if (this.mX5WebView != null) {
            ...
            mWebView = new top.xuqingquan.webbak.x5.AgentWebView(mActivity);
            WebConfig.WEBVIEW_TYPE = WebConfig.WEBVIEW_AGENTWEB_SAFE_TYPE;
        } else {
