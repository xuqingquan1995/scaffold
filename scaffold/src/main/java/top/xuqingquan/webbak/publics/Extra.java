...
import top.xuqingquan.webbak.nokernel.DownloadListener;
...
public class Extra implements Cloneable, Serializable {
    ...
    public top.xuqingquan.webbak.system.DefaultDownloadImpl create() {
        return new top.xuqingquan.webbak.system.DefaultDownloadImpl(this);
    }

    public top.xuqingquan.webbak.x5.DefaultDownloadImpl createX5() {
        return new top.xuqingquan.webbak.x5.DefaultDownloadImpl(this);
    }
