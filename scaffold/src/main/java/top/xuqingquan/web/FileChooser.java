...
public class FileChooser {
    ...
    private Intent getFileChooserIntent() {
        Intent mIntent = mFileChooserParams.createIntent();
        if (mIsAboveLollipop && mFileChooserParams != null && mIntent != null) {
            return mIntent;
        }
        ...
        mIntent = Intent.createChooser(i, "");
        return mIntent;
    }
    ...
    private void aboveLollipopCheckFilesAndCallback(final Uri[] datas, boolean isCamera) {
        ...
        //content://com.just.agentweb.sample.AgentWebFileProvider/agenweb_files/aw_20190618014833.jpg
        //content://top.xuqingquan.sample.ScaffoldFileProvider/agenweb_files/aw_20190618015314.jpg
        //content://top.xuqingquan.sample.ScaffoldFileProvider/web_download/Android/data/top.xuqingquan.sample/cache/agentweb-cache/aw_20190618013744.jpg
