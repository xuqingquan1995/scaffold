...
public class DefaultDownloadImpl implements DownloadListener {
    ...
    private ConcurrentHashMap<String, top.xuqingquan.web.nokernel.DownloadListener> mDownloadListeners = new ConcurrentHashMap<>();
    ...
    private void bind(Extra extra) {
        ...
        this.mAgentWebUIController = new WeakReference<>(AgentWebUtils.getAgentWebUIControllerByWebView(extra.mX5WebView));
    }
    ...
    private void preDownload(String url) {
        ...
        top.xuqingquan.web.nokernel.DownloadListener downloadListener = mDownloadListeners.get(extraService.getUrl());
        // true 表示用户取消了该下载事件。
...
//                mContext.getPackageManager().resolveActivity(mIntent)
    ...
    private DownloadListenerAdapter mDownloadAdapter = new DownloadListenerAdapter() {
        ...
        public void onProgress(String url, long downloaded, long length, long useTime) {
            ...
            top.xuqingquan.web.nokernel.DownloadListener downloadingListener = DefaultDownloadImpl.this.mDownloadListeners.get(url);
        ...
        public boolean onResult(Throwable throwable, Uri path, String url, com.download.library.Extra extra) {
            top.xuqingquan.web.nokernel.DownloadListener downloadListener = mDownloadListeners.remove(url);
    ...
    public static DefaultDownloadImpl create(@NonNull Activity activity,
                                             ...
                                             @Nullable top.xuqingquan.web.nokernel.DownloadListener downloadListener,
